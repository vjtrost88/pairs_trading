...
def stats(portfolio,trading_signals,stdate,eddate,capital0=10000):
    ...
    stats['numbers of longs']=(trading_signals['signals1'].loc[trading_signals['signals1']==1].count() +
                               trading_signals['signals2'].loc[trading_signals['signals2']==1].count())
    stats['numbers of shorts']=(trading_signals['signals1'].loc[trading_signals['signals1']<0].count() +
    ...
    stats['total length of trades']=(trading_signals['signals1'].loc[trading_signals['cumsum1']!=0].count() +
